...
- **Popup vs nearby cards:** `website/feature-info.js` (`vhfFeatureInfo.buildInfoTable`) is the shared field renderer for the map Leaflet popup and the Nearby list. Keep those in sync; do not fork a thinner nearby card.
