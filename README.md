...
Site owners: see `AUTH_SETUP.md` to connect the free sign-in project. Feature rows can be copied into Supabase (`supabase/README.md`); the public map still reads GitHub.
