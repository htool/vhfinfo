...
Site owners: see `AUTH_SETUP.md` to connect the free sign-in project. Feature rows live in Supabase (`supabase/README.md`); the website map reads that table, with GitHub as fallback.
