...
Site owners: see `AUTH_SETUP.md` to connect the free sign-in project. Feature rows live in Supabase (`supabase/README.md`); the public map still reads GitHub, and edit mode reads the database copy.
